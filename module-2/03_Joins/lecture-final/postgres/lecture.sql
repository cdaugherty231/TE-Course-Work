...
SELECT c.name as country, ci.name as capital
FROM city ci
RIGHT JOIN country c ON c.capital = ci.id;
...
--We want if they are from both to say AC
SELECT a.first_name, 'A,C' as source
FROM actor a 
JOIN customer c ON a.first_name = c.first_name

UNION
--just in actor and not in customer
SELECT a.first_name, 'A' as source
FROM actor a
LEFT JOIN customer c  ON a.first_name = c.first_name
WHERE c.first_name IS NULL

UNION
--just in customer and not in actor
SELECT c.first_name, 'C' as source
FROM actor a
RIGHT JOIN customer c  ON a.first_name = c.first_name
